...
@section('container')
    ...
    <section class="intro">
        <div class="wrapintro">
            ...
            <h2 class="lead">"Affiliates" is a free Bootstrap Template designed & developed by WowThemesNet, best
                suitable for affiliate marketers.</h2>
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-5 wrapthumbnail">
                                    <a href="single.html">
                                        <div class="thumbnail"
                                            style="background-image:url({{ asset('images/course/1.jpg') }});">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-7">
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-5 wrapthumbnail">
                                    <a href="single.html">
                                        <div class="thumbnail"
                                            style="background-image:url({{ asset('images/course/4.jpg') }});">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-7">
                                    <div class="card-block">
                                        <h2 class="card-title"><a href="single.html">Powerful things you can do
                                                with the Markdown editor</a></h2>
                        ...
                        <div class="sidebar-section">
                            ...
                            <ul style="list-none;">
                                ...
                                <li><a target="_blank"
                                        ...
                                        Speed Test</a></li>
                                <li><a target="_blank" href="https://elementor.com/?ref=1556">Elementor Page
                                        Builder</a></li>
                ...
                <div class="col-sm-8">
                    ...
                    <div class="masonrygrid row listrecent">
                        ...
                        <div class="col-md-6 grid-item">
                            <div class="card">
                                <a href="single.html">
                                    <img class="img-fluid" src="{{ asset('images/course/2.jpg') }}" alt="Tree of Codes">
                                </a>
                                <div class="card-block">
                        ...
                        <div class="col-md-6 grid-item">
                            <div class="card">
                                <a href="single.html">
                                    <img class="img-fluid" src="{{ asset('images/course/3.jpg') }}"
                                        alt="Red Riding Hood">
                                </a>
                                <div class="card-block">
                        ...
                        <div class="col-md-6 grid-item">
                            <div class="card">
                                <a href="single.html">
                                    <img class="img-fluid" src="{{ asset('images/course/5.jpg') }}"
                                        alt="Is Intelligence Enough">
                                </a>
                                <div class="card-block">
                                    <h2 class="card-title"><a href="single.html">Is Intelligence Enough</a></h2>
                                    <h4 class="card-text">Education must also train one for quick, resolute and
                                        effective thinking. To think incisively and to think for one’s self is very
                                        difficult. </h4>
                                    <div class="metafooter">
                                        <div class="wrapfooter">
                                            <span class="meta-footer-thumb">
                        ...
                        <div class="col-md-6 grid-item">
                            <div class="card">
                                <a href="single.html">
                                    <img class="img-fluid" src="{{ asset('images/course/6.jpg') }}"
                                        alt="Markdown Example">
                                </a>
                                <div class="card-block">
                                    <h2 class="card-title"><a href="single.html">Markdown Example</a></h2>
                                    <h4 class="card-text">You’ll find this post in your _posts directory. Go ahead
                                        and edit it and re-build the site to see your changes. You can rebuild the
                                        site in many different ways,...</h4>
                                    <div class="metafooter">
                                        <div class="wrapfooter">
                                            <span class="meta-footer-thumb">
                                                <img class="author-thumb"
