...
<body class="animsition">
    <div class="page-wrapper">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <a href="#informasi">
                                    ...
                                    <span class="bot-line"></span>Informasi</a>
                            </li>
                            <li>
                                <a href="#kelas">
        ...
        <div class="page-content--bgf7">
            ...
            <!-- STATISTIC-->
            <section class="statistic statistic2" id="informasi">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--green">
                                <h2 class="number">15</h2>
                                <span class="desc">Dituntaskan</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--orange">
                                ...
                                <span class="desc">Belum Tuntas</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--red">
                                <h2 class="number">1.250</h2>
                                <span class="desc">Point yang Diraih</span>
                                <div class="icon">
            ...
            <section class="p-t-60 p-b-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2023 Code of Source. All rights reserved. Template by <a
                                        href="https://sanrizk.com">Sanrizk</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
